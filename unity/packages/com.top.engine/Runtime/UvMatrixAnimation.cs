...
{
    /// <summary>
    /// Plays a UvAnimationTrack on one material slot. Sampling uses global
    /// time, so visibility culling pauses cost nothing and lose no phase.
    /// </summary>
    [RequireComponent(typeof(Renderer))]
    public sealed class UvMatrixAnimation : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                // No interpolation across the loop seam: scroll tracks
                // accumulate offset, and lerping the wrap would sweep backwards.
