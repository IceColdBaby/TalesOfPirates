...
namespace Top.Engine
{
    ...
    /// the object is selected: lines between parented transforms, spheres at
    /// joints, and labeled cubes on dummy locator nodes. Purely a viewing
    /// aid for meshless rigs and skinned parts; it renders nothing in play
    /// builds.
    /// </summary>
    public sealed class SkeletonGizmos : MonoBehaviour
    {
