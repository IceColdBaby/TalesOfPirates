...
namespace Top.Assets
{
    ...
    /// Resolving the state is the contract's job; what remains here is the
    /// step that needs Unity: the contract's blend and cull vocabulary
    /// becomes the Unity enums the shader reads.
    /// </summary>
