...
{
    public class SkinnedMapperTests
    {
        ...
        {
            var conversion = GeometryObjectGltfMapper.Map(MakeSkinnedObject(), MakeSkeleton(), "rig");
        ...
        {
            var doc = GeometryObjectGltfMapper.Map(MakeSkinnedObject(), MakeSkeleton(), "rig").Document;
        ...
        public void Converts_real_character_part_with_skeleton()
        {
            ...
            var conversion = GeometryObjectGltfMapper.Map(obj, skeleton, "0724000000");
            var doc = conversion.Document;

            // The shipped part carries four NaN normals.
            Assert.That(conversion.Warnings, Has.Count.EqualTo(1));
            Assert.That(conversion.Warnings[0], Does.Contain("4 degenerate normals"));
